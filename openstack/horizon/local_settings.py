...
ALLOWED_HOSTS = ['control.computer', ]
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'control.computer:11211',
    },
}
...
OPENSTACK_HOST = "control.computer"
OPENSTACK_KEYSTONE_URL = "http://%s:5555/identity/v3" % OPENSTACK_HOST
